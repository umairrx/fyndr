...
const Footer = () => {
    ...
    const socialLinks = [
        { icon: Instagram, href: "https://instagram.com/nizzypedia", label: "Instagram" },
        { icon: Linkedin, href: "https://www.linkedin.com/in/nizzypedia/", label: "LinkedIn" },
        { icon: Github, href: "https://github.com/umairniaziofficial", label: "GitHub" },
    ];
        ...
        <footer className="bg-background-black text-primary-color border-t border-white/10">
            <div className="mx-auto px-4 md:px-6 py-10 md:py-16">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
                    {/* Brand Section */}
                    <FadeContent duration={1000} delay={100} className="col-span-1 md:col-span-2 lg:col-span-1 space-y-4">
                        <Link href="/" className="inline-block">
                            <h2 className="text-3xl font-bold">Fyndr</h2>
                        </Link>
                        <p className="text-sm md:text-base text-gray-400">
                            Connecting startups with their ideal resources, investors, and research to fuel innovation and growth.
                        </p>
                    ...
                    {footerLinks.map((section, sectionIndex) => (
                        <FadeContent key={section.title} duration={1000} delay={200 + sectionIndex * 100} className="space-y-4">
                ...
                <FadeContent duration={1000} delay={500}>
                    <div className="mt-12 pt-8 border-t border-white/10 grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <p className="text-sm text-gray-400">Get the latest updates on startups, investors, and research.</p>
