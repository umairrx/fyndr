        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex-shrink-0">
            <Link href="/">
              <span className="text-3xl font-extrabold">
                Fynd<span className="text-secondary-color">r</span>
              </span>
            </Link>
          </div>
          ...
          <div className="hidden md:flex items-center gap-5">
            {session && session?.user ? (
              <div className="flex items-center gap-4">
                ...
                <Link href={`/user/author-${session?.user?.id}`}>
                  <Avatar>
                    <AvatarImage
                ...
                <Link
                  href={`/user/author-${session?.user?.id}`}
          ...
          <div className="md:hidden">
            <Button
              variant="secondary"
              size="icon"
              className="peer !bg-white/5 !text-white"
              aria-label="Menu"
            >
              ...
              <div className="fixed top-0 right-0 h-full w-[80%] max-w-sm bg-black p-6 shadow-lg">
                ...
                <div className="flex flex-col gap-6">
                  <div className="flex flex-col gap-4">
                    ...
                    <Link
                      href="#about"
                      className="text-lg text-custom-gray hover:text-white transition-colors"
                    >
                      About
                    </Link>
                    <Link
